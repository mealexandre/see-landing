  ...
  return (
    <nav style={{
      ...
      <div style={{ display: 'flex', gap: '1.5rem', alignItems: 'center' }}>
        ...
        <a href="#demo" style={{ color: '#94a3b8', textDecoration: 'none', fontSize: '0.95rem' }}>Demo</a>
        <a href="#waitlist" style={{ color: '#94a3b8', textDecoration: 'none', fontSize: '0.95rem' }}>Waitlist</a>
